...
const spotLight = () =>{
    let light = new THREE.SpotLight("#FFFFFF", 1.2, 0) //Parameter beda sama soal
...
// Text
const text = () =>{
    let loader = new FontLoader().load("./three.js-r145-compressed/three.js-r145-compressed/examples/fonts/gentilis_bold.typeface.json", function(font){
